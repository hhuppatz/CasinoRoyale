...
public static class PacketPoolManager
{
    ...
    public static PacketPool<T> GetPool<T>()
        where T : class, new()
    {
        lock (_poolsLock)
        {
    ...
    public static void Return<T>(T packet)
        where T : class, new()
    {
...
public static class PacketPoolExtensions
{
    ...
    public static void UsePooledPacket<T>(Action<T> action)
        where T : class, new()
    {
    ...
    public static TResult UsePooledPacket<T, TResult>(Func<T, TResult> func)
        where T : class, new()
    {
        var packet = PacketPoolManager.Rent<T>();
        try
