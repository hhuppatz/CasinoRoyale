...
public class MenuGameState(Game game, IGameStateManager stateManager)
    : GameState(game, stateManager)
{
    ...
    public override void LoadContent()
    {
        ...
        _hostButtonRect = new Rectangle(
            centerX - hostButtonWidth / 2,
            centerY - 50,
            hostButtonWidth,
            hostButtonHeight
        );
        ...
        _inputBoxRect = new Rectangle(
            centerX - inputBoxWidth / 2,
            centerY + 50,
            inputBoxWidth,
            inputBoxHeight
        );
    ...
    private void HandleInput(KeyboardState keyboardState, MouseState mouseState)
    {
        ...
        if (
            ...
            && !string.IsNullOrEmpty(_lobbyCodeInput)
            && _lobbyCodeInput.Length == 6
        )
        {
    ...
    private void DrawMenu()
    {
        ...
        var borderRect = new Rectangle(
            _inputBoxRect.X - 2,
            _inputBoxRect.Y - 2,
            _inputBoxRect.Width + 4,
            _inputBoxRect.Height + 4
        );
    ...
    private void DrawClickableButton(
        string text,
