...
public class ItemManager
{
    ...
    public ItemManager(ContentManager content, Properties properties)
    {
        ...
        _coinFactory = new CoinFactory(content.Load<Texture2D>(properties.get("coin.image", "Coin")));
        _swordFactory = new SwordFactory(content.Load<Texture2D>(properties.get("sword.image", "Sword")));
