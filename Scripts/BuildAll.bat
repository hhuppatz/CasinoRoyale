...
echo [1/4] Building main project...
...
echo [4/4] Updating Instance3...
if exist "Build\Instance3" rmdir /s /q "Build\Instance3"
mkdir "Build\Instance3"

echo Copying all game files...
xcopy "Build\bin\Release\net8.0\*" "Build\Instance3\" /Y /E /I /Q
copy "app.properties" "Build\Instance3\app.properties" /Y > nul
